...
const Hero = () => {
  ...
  return <section ref={component} className="relative">
    <Image src="/images/creative_corner.png" width={1456} height={816} alt="Creative Corner" className="w-full aspect-video object-cover lg:aspect-[5/2]" />
